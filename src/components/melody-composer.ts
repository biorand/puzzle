    ...
    render() {
        return html`
            <div id="melody-wrap">
                ...
                <div id="melody-hint">
                    Format: <code>NoteOctave/Duration</code>, <code>R</code> or <code>Z</code> for
                    rests. Duration: <code>/4</code> = quarter, <code>/8</code> = eighth,
                    <code>/1.0</code> = whole, <code>/2.0</code> = double. Volume:
                    <code>D5/4[0.6]</code> = 60% volume. Sharps: <code>CS5</code> = C♯5, Flats:
                    <code>EB4</code> = E♭4. <strong>Chords:</strong> put each voice on its own line,
                    all lines play simultaneously.
                </div>
                ...
                <div id="melody-legend">
                    <div class="melody-legend-title">
                        Piano Reference (Scientific Pitch Notation)
                    </div>
                    <div class="melody-legend-grid">
                        <span>C4=262</span> <span>D4=294</span> <span>E4=330</span>
                        <span>F4=349</span> <span>G4=392</span> <span>A4=440</span>
                        <span>B4=494</span> <span>C5=523</span> <span>D5=587</span>
                        <span>E5=659</span> <span>F5=698</span> <span>G5=784</span>
